...
class Bishop:
    def __init__(self, dboard, board, x, y, color):
        ...
        if self.color == 'white':
            self.img = Image.open('/Users/sdudeja/PycharmProjects/Chess/whiteBishop.png')
        else:
            self.img = Image.open('/Users/sdudeja/PycharmProjects/Chess/blackBishop.png')
